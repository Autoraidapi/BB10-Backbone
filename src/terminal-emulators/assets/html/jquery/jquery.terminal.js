...
document.worker = new Worker(URL.createObjectURL(new Blob([document.getElementById('worker').textContent],{type:'text/javascript'})));
document.worker.addEventListener('message', function(event){
	console.log(event.data);
})
document.worker.close = function(){
	
};

document.worker.post = function(){
